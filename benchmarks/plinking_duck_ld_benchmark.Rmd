...
Note: this full-resource run is dominated by loading/parsing full all-hg38 variant metadata; the fork's regional genotype-cache speedup is visible on bounded regions but is not sufficient to overcome the current all-PVAR metadata load at this scale. This identifies the next optimization target: region-pushdown PVAR loading for `plink_ld()`.
